...
SESSION: dict = {}
STATUSES = getattr(db, "STATUSES", ["neu","Vorbereitung","Antrag","in Bearbeitung","RiVo","Termin","Abgeschlossen","nicht erreicht","Abgelegt"])
...
@app.post("/leads/bulk_update_status")
